  ...
  return (
    <div className={`flex flex-col justify-between bg-[#212327] pt-7 transition-all z-50 max-md:absolute max-md:h-screen  ${expand ? 'p-4 w-64' : 'md:w-20 w-0 max-md:overflow-hidden'}`}>
        ...
        <div>
            ...
            <div onClick={openSignIn} className={`flex items-center ${expand ? 'hover:bg-white/10 rounded-lg' : 'justify-center w-full'} gap-3 text-white/50 text-sm p-2 mt-2 cursor-pointer`}>
                <Image src={assets.profile_icon} alt='user-profile' className="w-7" />
